...
class JobEmbeddingStore:
    def __init__(self, db_uri: str = None, jina_api_key: str = None, groq_api_key: str = None):
        ...
        self.jina_api_key = jina_api_key or "jina_71a2d1c8cf884d6593a35a6a5d89ad2fp2BEEYkIHuIpXMXv7PIXHfFOk5vU"
        ...
        self.groq_api_key = groq_api_key or "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"
    ...
    def store_job(self, job_title: str, job_description: str, 
        ...
        try:
            ...
            embedding = self.embedding_model.embed_query(job_text)
    ...
    def summarize_job_text(self, content, prompt=None):
        """
        Summarize job text using Groq LLM.
        """
        if prompt is None:
            prompt="""
